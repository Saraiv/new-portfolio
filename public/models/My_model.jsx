...
Command: npx gltfjsx@6.2.18 my_model.glb 
*/
...
export function Avatar(props) {
  ...
  const { actions } = useAnimations(waving, group)
  ...
  return (
    <group {...props} ref={group} dispose={null} position={[0, -1.8, 0]} scale={[2, 2, 2]} rotation={[0.5, 0, 0]}>
